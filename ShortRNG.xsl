...
<!--
	...
	$Id: ShortRNG.xsl,v 1.4.1 2014-12-11 bear Exp bear $
                      Copyright (C) 2001, Kohsuke KAWAGUCHI
                         e-mail: kk at kohsuke dot org
                      Copyright (C) 2008, Tobias MINICH
                         e-mail: belgabor at gmx dot de
                      License: GPLv2 (originally GPL)

	$Log: ShortRNG.xsl,v $
	Revision 1.4.1 2014-12-11 Tobias Minich
	Small license & header update 
